...
const Pagination=({length,callBackResult})=>{const{0:page,1:setPage}=(0,compat_js_.useState)(0);const handleClick=index=>{if(callBackResult){callBackResult(index);}setPage(index);};const paginationContent=Array.from({length}).map((_,index)=>{const firstPage=index===0;const pageNum=index+1;const url=firstPage?"/":`/?page=${pageNum}`;const isSelected=page===index;const disableClass=isSelected?" pointer-events-none":"";return/*#__PURE__*/compat_js_default().createElement(gatsby_browser_entry.Link,{to:url,onClick:()=>handleClick(index),className:`relative rounded-md border border-blue shadow-sm px-4 py-2 text-sm ${isSelected?"bg-blue text-white":"bg-white text-blue"}${disableClass}`,disabled:isSelected,key:`page-${pageNum}`},pageNum);});return/*#__PURE__*/compat_js_default().createElement("nav",{className:"flex justify-end space-x-2 rounded-md mt-10","aria-label":"Page navigation"},paginationContent);};Pagination.propTypes={length:(prop_types_default()).number.isRequired,callBackResult:(prop_types_default()).func.isRequired};/* harmony default export */ const components_Pagination = (Pagination);
// EXTERNAL MODULE: ./src/config/constants/index.js
var constants = __webpack_require__(3128);
;// CONCATENATED MODULE: ./src/components/PostListLayout.jsx
const chunkList=(list,size)=>{let length=list.length;let chunked=[];Array.from({length:Math.ceil(length/size)},(val,i)=>{return chunked.push(list.slice(i*size,i*size+size));});return chunked;};const PostListLayout=({data})=>{const selectedDataIndex=(0,compat_js_.useRef)(0);// eslint-disable-next-line react-hooks/exhaustive-deps
const memoizedData=(0,compat_js_.useMemo)(()=>chunkList(data,constants/* POSTS_PER_PAGE */.DB),[]);const chunkPostLength=memoizedData.length;const handlePaginationPage=currentNum=>{selectedDataIndex.current=currentNum;};const postCard=memoizedData[selectedDataIndex.current].map(({id,frontmatter,slug},index)=>/*#__PURE__*/compat_js_default().createElement("article",{className:"relative rounded-lg shadow-sm bg-white pb-5 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300",key:id},/*#__PURE__*/compat_js_default().createElement("div",{className:"mx-auto w-full"},/*#__PURE__*/compat_js_default().createElement(Image/* default */.Z,{className:"rounded-t-lg h-56",filename:frontmatter===null||frontmatter===void 0?void 0:frontmatter.featuredImage,title:frontmatter===null||frontmatter===void 0?void 0:frontmatter.title,withFallback:!(frontmatter!==null&&frontmatter!==void 0&&frontmatter.featuredImage)})),/*#__PURE__*/compat_js_default().createElement("header",{className:"mt-2 px-5"},/*#__PURE__*/compat_js_default().createElement("time",{className:"text-gray font-light text-base",dateTime:frontmatter===null||frontmatter===void 0?void 0:frontmatter.datetime},frontmatter===null||frontmatter===void 0?void 0:frontmatter.date),/*#__PURE__*/compat_js_default().createElement("h3",{className:"text-xl text-black font-semibold m-0"},/*#__PURE__*/compat_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:underline",to:`/${slug}`},frontmatter===null||frontmatter===void 0?void 0:frontmatter.title)))));return/*#__PURE__*/compat_js_default().createElement((compat_js_default()).Fragment,null,/*#__PURE__*/compat_js_default().createElement("section",{className:"mt-16 grid gap-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4"},postCard),/*#__PURE__*/compat_js_default().createElement(components_Pagination,{length:chunkPostLength,callBackResult:handlePaginationPage}));};PostListLayout.propTypes={data:(prop_types_default()).array.isRequired};/* harmony default export */ const components_PostListLayout = (PostListLayout);
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/defineProperty.js
var defineProperty = __webpack_require__(4942);
;// CONCATENATED MODULE: ./src/components/SubscribeForm.jsx
/* provided dependency */ var fetch = __webpack_require__(1515);
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;})),keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{};i%2?ownKeys(Object(source),!0).forEach(function(key){(0,defineProperty/* default */.Z)(target,key,source[key]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}return target;}const Newsletter=({actionUrl,handleSubmittedForm})=>{const btnText=constants/* PAGE_CONTENT.subscribe_form_btn */.yi.subscribe_form_btn;const description=constants/* PAGE_CONTENT.subscribe_description */.yi.subscribe_description;const thankYouMsg=constants/* PAGE_CONTENT.subscribe_thankyou */.yi.subscribe_thankyou;const tahnkYouDesc=constants/* PAGE_CONTENT.subscribe_msg */.yi.subscribe_msg;const emailPlaceholder=constants/* PAGE_CONTENT.subscribe_form_email */.yi.subscribe_form_email;const{0:isSubmited,1:setSubmit}=(0,compat_js_.useState)(false);const{0:formInputs,1:setFormInputs}=(0,compat_js_.useState)({email:""});let formContent;if(!actionUrl)return;const handleSubmit=e=>{e.preventDefault();const{email}=formInputs;//{"success":false,"errors":{"fields":{"email":["The email field is required."]}}}
const params=`fields[email]=${email}`;//&fields[name]=...
// Send a POST request
fetch(actionUrl,{headers:{"Content-Type":"application/x-www-form-urlencoded; charset=utf-8"},method:"POST",body:params}).then(response=>{console.log(response);if(response.status===200){setSubmit(true);if(handleSubmittedForm){handleSubmittedForm(true);}}}).catch(error=>console.log(error));};const handleInputChange=e=>{const{name,value}=e.target;setFormInputs(_objectSpread(_objectSpread({},formInputs),{},{[name]:value}));};formContent=/*#__PURE__*/compat_js_default().createElement("div",{className:"flex flex-wrap mt-10",onSubmit:handleSubmit},/*#__PURE__*/compat_js_default().createElement("form",{className:"relative flex rounded-full w-full max-w-sm bg-gray-light order-last md:order-first"},/*#__PURE__*/compat_js_default().createElement("input",{type:"email",className:"form-input px-4 py-3 rounded-full border-0 bg-gray-light w-full",placeholder:emailPlaceholder,name:"email",autocomplete:"email",value:formInputs.email,onChange:handleInputChange,required:true}),/*#__PURE__*/compat_js_default().createElement("button",{className:"rounded-full text-xl bg-black hover:bg-blue text-white py-1 px-4 ml-auto min-w-fit",type:"submit"},btnText)),/*#__PURE__*/compat_js_default().createElement("p",{className:"max-w-xs font-light text-lg leading-tight mb-3 md:my-auto ml-3"},description));if(isSubmited){formContent=/*#__PURE__*/compat_js_default().createElement("div",{className:"inline-block border border-emerald-500 p-3 rounded"},/*#__PURE__*/compat_js_default().createElement("p",{className:"text-black font-bold text-xl mb-0"},thankYouMsg),/*#__PURE__*/compat_js_default().createElement("p",{className:"mb-0 text-emerald-500"},tahnkYouDesc));}return formContent;};Newsletter.defaultProps={handleSubmittedForm:null};Newsletter.propTypes={handleSubmittedForm:(prop_types_default()).func};/* harmony default export */ const SubscribeForm = (Newsletter);
;// CONCATENATED MODULE: ./src/components/SocialMedia.jsx
const SocialMedia=({text,className})=>{const twitterURL=constants/* URL_LIST.twitter */.bb.twitter;const linkedinURL=constants/* URL_LIST.linkedin */.bb.linkedin;const githubURL=constants/* URL_LIST.github */.bb.github;const Twitter=constants/* SOCIA_MEDIA_LIST.twitter */.eU.twitter;const Linkedin=constants/* SOCIA_MEDIA_LIST.linkedin */.eU.linkedin;const Github=constants/* SOCIA_MEDIA_LIST.github */.eU.github;return/*#__PURE__*/compat_js_default().createElement("div",{className:className?className:""},/*#__PURE__*/compat_js_default().createElement("p",{className:"text-xl my-auto"},text),/*#__PURE__*/compat_js_default().createElement("a",{href:twitterURL,"aria-label":"Twitter",target:"_blank",rel:"noreferrer"},/*#__PURE__*/compat_js_default().createElement(Twitter,{className:"text-gray text-3xl"})),/*#__PURE__*/compat_js_default().createElement("a",{href:linkedinURL,"aria-label":"Linkedin",target:"_blank",rel:"noreferrer"},/*#__PURE__*/compat_js_default().createElement(Linkedin,{className:"text-gray text-3xl"})),/*#__PURE__*/compat_js_default().createElement("a",{href:githubURL,"aria-label":"Github",target:"_blank",rel:"noreferrer"},/*#__PURE__*/compat_js_default().createElement(Github,{className:"text-gray text-3xl"})));};/* harmony default export */ const components_SocialMedia = (SocialMedia);
;// CONCATENATED MODULE: ./src/pages/index.jsx
const IndexPage=({data,location})=>{const{nodes}=data.allMdx;const title=constants/* PAGE_CONTENT.title */.yi.title;const seoTitle=constants/* PAGE_CONTENT.seo_title */.yi.seo_title;const occupation=constants/* PAGE_CONTENT.occupation */.yi.occupation;const blogTitle=constants/* PAGE_CONTENT.blog_title */.yi.blog_title;const blogDesc=constants/* PAGE_CONTENT.blog_description */.yi.blog_description;const socialMediaText=constants/* PAGE_CONTENT.social_media */.yi.social_media;const subscribeURL=constants/* PAGE_CONTENT.subscribe_url */.yi.subscribe_url;const intro=/*#__PURE__*/compat_js_default().createElement("h1",{className:"max-w-5xl tracking-tight text-black text-5xl font-bold lg:text-6xl xl:text-7xl"},title,",",/*#__PURE__*/compat_js_default().createElement("br",null),/*#__PURE__*/compat_js_default().createElement("span",{className:"text-blue"},occupation),".");const welcome=/*#__PURE__*/compat_js_default().createElement((compat_js_default()).Fragment,null,/*#__PURE__*/compat_js_default().createElement("h2",{className:"font-light text-4xl mt-5"},blogTitle),/*#__PURE__*/compat_js_default().createElement("p",{className:"mt-4 max-w-3xl text-2xl"},blogDesc));return/*#__PURE__*/compat_js_default().createElement((compat_js_default()).Fragment,null,/*#__PURE__*/compat_js_default().createElement(Seo/* default */.Z,{title:seoTitle}),intro,welcome,/*#__PURE__*/compat_js_default().createElement(SubscribeForm,{actionUrl:subscribeURL}),/*#__PURE__*/compat_js_default().createElement(components_SocialMedia,{className:"flex space-x-4 mt-3 ml-3",text:socialMediaText}),/*#__PURE__*/compat_js_default().createElement(components_PostListLayout,{data:nodes}));};/* harmony default export */ const pages = (IndexPage);const query="974192776";
